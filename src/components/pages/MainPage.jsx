                ...
                >
                    <Grid item xs={3}>
                        <Item sx={{ padding: '0', borderRadius: '16px', boxShadow: 'none' }}>
                            ...
                            >
                                {loading ? (
                                    <Skeleton variant='rectangular' width='100%' height='110px' sx={{ borderRadius: '16px' }}>
                                        <a href="">
                                            <img src="" alt="" />
                                        </a>
                                    </Skeleton>
                                ...
                                >
                                    {loading ? (
                                        <Skeleton variant='rectangular' width='95%' height='20px' sx={{ marginBottom: '10px' }}>
            ...
            <Box sx={{ background: '#000', height: '300px', display: 'flex', alignItems: 'center' }}>
                <div className="container">
                    ...
                    <Box className="box3" sx={{ textAlign: 'center', pt: 3 }}>
                        <section classNAme="section-container action-section -fill -center" id="section-9302753"><Button name="button" type="button" data-url="/forms/orders/new/40700?locale=ru&amp;page_id=1697000" sx={{
                            borderRadius: '100px', background: '#fff', p: 3, color: '#252525', '&:hover': {
                                background: '#fff'
                            }
